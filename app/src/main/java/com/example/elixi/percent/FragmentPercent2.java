 ...
 * {@link FragmentPercent2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link FragmentPercent2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentPercent2 extends Fragment  {
    EditText etNumber,etPercent,etPercent2;
    TextView tv;
    ImageButton im;
    SQL  myDb;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_fragment_percent2, container, false);
        ...
        etPercent2=(EditText)view.findViewById(R.id.etPercent2);
        ...
        etPercent2.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
    ...
    private void push(boolean isPush) {
        ...
        if(!etPercent.getText().toString().isEmpty()&&!etPercent2.getText().toString().isEmpty()&&
            ...
            arr.add(new DB(etNumber.getText().toString(),etPercent.getText().toString(),
                    etPercent2.getText().toString(),final_ans));

            boolean isInserted = myDb.insertData(etNumber.getText().toString(),
                    etPercent.getText().toString(),etPercent2.getText().toString(),
                    final_ans );

        }
        else{
            if(MainActivity.isOpen) {
                MainActivity.animatefab();
            }
    ...
    public String doMath(String ans){
        String final_ans="";
        boolean flag=false;
        String s=".";
        String s_0="0";
